...
public class Dashboard extends AppCompatActivity {
    ...
    private void initRecyclerView() {
        ...
        items3.add(new PopularDomain("Cala Granadella","Costa Blanca, Spain","Cala Granadella is known for its crystal-clear waters and picturesque surroundings. It's a popular spot for snorkeling, swimming, and sunbathing. The cove is surrounded by rugged cliffs covered in lush vegetation, making it a beautiful natural setting.","","beach1", "free"));
